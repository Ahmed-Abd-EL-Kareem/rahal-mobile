...
This document lists 5 issues found during testing, with root-cause hypotheses and concrete fix instructions. Work through them in order — items 1 and 5 are related (same asset), items 3 and 4 are backend/contract issues that need both sides checked.
